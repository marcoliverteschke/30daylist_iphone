...
- (void)applicationDidBecomeActive:(UIApplication *)application {
	...
	if ([navigationController.topViewController isMemberOfClass:[ProductsOverviewController class]]) {
		NSLog(@"Overview… RELOAD!!!");
		ProductsOverviewController *viewController = (ProductsOverviewController *)navigationController.topViewController;
		[viewController reloadProductsTable];
	} else {
		NSLog(@"do NOT reload!");
	}
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"_0daylist_iphone" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"_0daylist_iphone.sqlite"];
